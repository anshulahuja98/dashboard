...
import {CreateSecretDialogMeta} from '../form/createsecret/dialog';
import {AlertDialog, AlertDialogConfig} from '../../../common/dialogs/alert/dialog';
import {CreateNamespaceDialog} from '../form/createnamespace/dialog';
import {ActivatedRoute} from '@angular/router';

export interface UpsertSecretComponentMeta {
  namespace: string;
}

@Component({
  selector: 'kd-upsert-secret-component',
  templateUrl: 'template.html',
})
export class UpsertSecretComponent implements OnInit {
  form: FormGroup;
  inputData = '';
  namespaces: string[];
  ...
  constructor(
    // public dialogRef: MatDialogRef<UpsertSecretComponent>,
    //  @Inject(MAT_DIALOG_DATA) public data_: UpsertSecretComponentMeta,
  ...
  createSecret(): void {
    ...
    tokenPromise.subscribe(csrfToken => {
      return this.http_.post<{valid: boolean}>(
        'api/v1/secret/',
        {...secretSpec},
        {
